...
export function getRapports(userId: string): Promise<RapportsData> {
  return unstable_cache(
    ...
    ['rapports', userId],
    { revalidate: 60, tags: [`rapports-${userId}`] },
  )();
}

export function getRapportsPeriode(
  userId: string,
  dateDebut: string,
  dateFin: string,
  ...
  return unstable_cache(
    ...
    ['rapports-periode', userId, dateDebut, dateFin],
    { revalidate: 60, tags: [`rapports-${userId}`] },
  )();
}
